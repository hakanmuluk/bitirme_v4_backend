...
from routes import stockRoute, currencyRoute, loginRoute, logoutRoute, favoriteRoute, viewForestRoute, processNotificationRoute, saveNotificationRoute, reportRoute, chatbotRoute, chainlitStaticRoute  # Import your route modules
...
app.include_router(chatbotRoute.chat_router, prefix="/api/ask")
app.include_router(chainlitStaticRoute.router)
