...
from routes import stockRoute, currencyRoute, loginRoute, logoutRoute, favoriteRoute, viewForestRoute, processNotificationRoute, saveNotificationRoute, reportRoute, chatbotRoute  # Import your route modules
